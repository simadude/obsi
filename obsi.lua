...
local function isAdvanced()
    -- the difference between normal and advanced computers in ComputerCraft
    -- is that only advanced computers have "multishell" program.
...
obsi.mouse = require("mouse")(isAdvanced())
obsi.sound, soundLoop = require("sound")(path)
    ...
    while true do
        ...
        elseif eventData[1] == "term_resize" then
            ...
            if config.renderingAPI == "parea" or config.renderingAPI == "hmon" then
                ...
                -- bruh pixelbox
                pixelbox.RESTORE(canvas, colors.black, w, h)
            end
